...
<body class="u-body u-xl-mode" data-lang="it">
  <section class="u-align-center u-clearfix u-image u-section-1" id="carousel_bad6" data-image-width="1440" data-image-height="1080">
    <h2 class="u-align-center u-text u-text-default u-text-1">Modifica valutazione</h2>
    <div class="u-form u-radius-20 u-white u-form-1">
      <form class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" source="email" name="form" style="padding: 23px;" id="form">
        <div class="u-form-group u-form-group-1">
          ...
          <input type="text" placeholder="" id="text-81a7" name="ragioneSociale" class="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-radius-10 u-input-1" value="<?= $info['ragione_sociale'] ?>" required="required">
        </div>
        <div class="u-form-date u-form-group u-form-group-2">
          <label for="date-e23d" class="u-label">Data emissione</label>
          <input type="date" placeholder="DD/MM/YYYY" id="date-e23d" name="data" class="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-radius-10 u-input-2" required="" data-date-format="mm/dd/yyyy" value="<?= $info['data_emissione'] ?>">
        </div>
        <div class="u-form-group u-form-group-9">
          <label for="text-4739" class="u-label">Peso</label>
          <input type="number" placeholder="" min="3" id="text-4739" name="peso" class="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-radius-10 u-input-9" required="required" value="<?= $info['peso'] ?>">
        </div>
        ...
        <div class="u-form-group u-form-select u-form-group-7">
          ...
          <div class="u-form-select-wrapper">
            <select id="select-e411" name="giudizio" class="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-radius-10 u-input-7" required="required">
              <option value="<?= $info['giudizio'] ?>" selected hidden><?= $info['giudizio'] ?></option>
        ...
        <div class="u-form-checkbox u-form-group u-form-group-11">
          <input type="checkbox" id="checkbox-76be" name="duePersone" value="On" required="required" <?= $info['due_persone'] === 0 ? '' : 'checked' ?>>
        ...
        <div class="u-align-right u-form-group u-form-submit">
          <a class="u-active-palette-3-base u-border-5 u-border-active-palette-3-base u-border-hover-palette-3-base u-border-palette-2-base u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-3-base u-palette-2-base u-radius-10 u-btn-1" id="aggiungi">Modifica</a>
...
<script>
  $("#aggiungi").click(function(e) {
    ...
    $.ajax({
      type: "POST",
      url: "modifyEvaluation",
      data: $("form").serialize(),
      dataType: "json",
      success: function(response) {
        if (response == "ok") {
          location.href = "visualizza?me"
        }
      }
    });
  });
